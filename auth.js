...
(function(){
  ...
  var FIREBASE_CONFIG = {
    ...
    authDomain:        "pradoworth.github.io",
  ...
  function signIn(){
    ...
    /* Popup funciona melhor com authDomain = próprio domínio */
    _auth.signInWithPopup(provider).then(function(result){
      console.log('[GonAuth] popup login OK:', result.user.email);
    }).catch(function(err){
      console.error('[GonAuth] popup error:', err.code, err.message);
