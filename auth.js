...
(function(){
  ...
  function init(){
    ...
    /* mostra "Carregando..." enquanto o Firebase resolve o estado de auth
       (especialmente importante após o redirect do Google) */
    ...
    if (loginStatusTxt) loginStatusTxt.textContent = 'Verificando login...';
    ...
    _auth.getRedirectResult().catch(function(err){
      ...
      if (loginStatusTxt) loginStatusTxt.textContent = 'Erro ao fazer login. Tente novamente.';
    ...
    _auth.onAuthStateChanged(function(user){
      /* esconde o spinner assim que o estado resolve */
      if (loginStatus)    loginStatus.hidden = true;
